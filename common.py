...
tf.keras.backend.set_image_data_format('channels_last') #Put this elsewhere?
...
def train(preprocess_input, network, PATH, SAVE_PATH, BATCH_SIZE=64, IMG_SIZE=(512,632), initial_epochs=10, fine_tune_epochs=10, layers_to_fine_tune=3, base_learning_rate=0.01):
	metrics = [
	...
	#Maybe fix the weights? Or we go unweighted
